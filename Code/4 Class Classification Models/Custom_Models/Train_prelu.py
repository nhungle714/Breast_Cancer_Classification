...
from custom_model_prelu import *
...
torch.save(model.state_dict(), 'Model_Prelu_Wt_noinputdrop')
torch.save(checkpoint_mdl_wt,'Model_Prelu_cont_chkpt_Wt_noinputdrop')
torch.save(checkpoint_optim,'Model_Prelu_cont_chkpt_optim_noinputdrop')
torch.save(checkpoint_scheduler,'Model_Prelu_cont_chkpt_scheduler_noinputdrop')
pickle.dump(acc_dict,open("Model_Prelu_cont_AccDict_noinputdrop.pkl","wb"))
pickle.dump(loss_dict,open("Model_Prelu_cont_LossDict_noinputdrop.pkl","wb"))